...
import { EmotionalState, Trigger } from './types';
...
export const seedRecords: RawSeedRecord[] = [
  {
...
export async function seedDevData() {
  console.log('Starting deletion of existing consumption records...');
  ...
  console.log('Successfully cleared old records. Starting insert of seed records...');

  const recordsToInsert = seedRecords.map(record => ({
    fecha: record.dateTime, // Note: already in ISO format from JSON
